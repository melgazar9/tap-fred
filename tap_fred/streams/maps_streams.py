...
class GeoFREDRegionalDataStream(FREDStream):
    ...
    path = "/regional/data"
    primary_keys: t.ClassVar[list[str]] = ["region", "series_group", "date", "region_type"]
    ...
    schema = th.PropertiesList(
        ...
        th.Property("region_type", th.StringType, description="Region type (state, county, msa)"),
        th.Property("season", th.StringType, description="Seasonality (SA, NSA, SSA, SAAR, NSAAR)"),
    ...
    def partitions(self):
        ...
        if not isinstance(regional_params, list):
            raise ValueError("geofred_regional_params must be an array of parameter sets")
    ...
    def get_records(self, context: Context | None) -> t.Iterable[dict]:
        ...
        for record in matches:
            ...
            record.update({
                ...
                "units": response_data.get("meta", {}).get("units", context.get("units", "")),
            })
...
class GeoFREDSeriesDataStream(FREDStream):
    ...
    def get_records(self, context: Context | None) -> t.Iterable[dict]:
        ...
        if not context or "series_id" not in context:
            raise ValueError("GeoFREDSeriesDataStream requires series_id in partition context")
